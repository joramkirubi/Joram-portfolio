# ==============================================================
# Portfolio update script #4 - adds copy-to-clipboard fallback
# for the Email contact card.
# Usage:  .\update-portfolio-4.ps1
# ==============================================================

Write-Host "Starting portfolio update #4..." -ForegroundColor Cyan
