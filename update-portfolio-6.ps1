# ==============================================================
# Portfolio update script #6 - adds LangGraph, LangSmith, DeepEval,
# Ragas, and MCP to the tech stack and AI Agent Suite project.
# Usage:  .\update-portfolio-6.ps1
# ==============================================================

Write-Host "Starting portfolio update #6..." -ForegroundColor Cyan
