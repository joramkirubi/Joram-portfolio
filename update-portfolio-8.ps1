# ==============================================================
# Portfolio update script #8 - adds Guardrails to the tech stack
# and AI Agent Suite project.
# Usage:  .\update-portfolio-8.ps1
# ==============================================================

Write-Host "Starting portfolio update #8..." -ForegroundColor Cyan
