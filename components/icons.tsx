// Lucide's core icon set no longer ships brand/logo glyphs (Github,
// Linkedin, etc.), so these are provided as small inline SVGs with the
// same size/className API as lucide-react icons for a drop-in fit.
